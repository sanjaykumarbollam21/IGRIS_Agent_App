# Security-First Vibe Coding Rules — IGRIS AGENT
...
- Always return generic error messages to users: `'Something went wrong'` not `'Error: Cannot read property of undefined at /src/routes/user.ts:48'`.
...
## 🤖 AI/LLM-SPECIFIC RULES (this app uses AI)
